...
wire   [2:0] add_ln8_fu_127_p2;
reg   [2:0] add_ln8_reg_179;
...
wire   [2:0] add_ln10_fu_148_p2;
reg   [2:0] add_ln10_reg_207;
...
wire   [63:0] zext_ln8_fu_115_p1;
wire   [63:0] zext_ln10_fu_137_p1;
reg   [2:0] i_fu_42;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_42 <= 3'd0;
    end else if (((icmp_ln10_fu_142_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln8_fu_121_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        resultVecror_arr_addr_reg_189 <= zext_ln8_fu_115_p1;
    end
end
...
always @ (*) begin
    if (((icmp_ln8_fu_121_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        resultVecror_arr_address0 = zext_ln8_fu_115_p1;
    end else begin
...
always @ (*) begin
    if (((icmp_ln10_fu_142_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign add_ln10_fu_148_p2 = (j_reg_85 + 3'd1);

assign add_ln8_fu_127_p2 = (i_fu_42 + 3'd1);
...
assign firstVector_arr_address0 = zext_ln10_fu_137_p1;

assign grp_fu_162_p1 = conv4_reg_194;

assign icmp_ln10_fu_142_p2 = ((j_reg_85 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln8_fu_121_p2 = ((i_fu_42 == 3'd4) ? 1'b1 : 1'b0);

assign resultVecror_arr_d0 = add3_reg_96;

assign secondVector_arr_address0 = zext_ln8_fu_115_p1;

assign zext_ln10_fu_137_p1 = j_reg_85;

assign zext_ln8_fu_115_p1 = i_fu_42;
