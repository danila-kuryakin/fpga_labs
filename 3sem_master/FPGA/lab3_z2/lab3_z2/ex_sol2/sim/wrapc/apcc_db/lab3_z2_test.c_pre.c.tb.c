...
signed int main(void) {
  ...
  static  unsigned long long aesl_llvm_cbe_actual_out_count = 0;
  signed short llvm_cbe_actual_out[8192];    /* Address-exposed local */
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [8192 x i16]* %%in, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [8192 x i16]* %%out, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_46_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [8192 x i16]* %%actual_out, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_47_count);
  llvm_cbe_tmp__19 = (signed short *)(&llvm_cbe_actual_out[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 8192
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = call i32 bitcast (i32 (...)* @srand to i32 (i32)*)(i32 6789) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  srand(6789u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",6789u);
...
llvm_cbe_tmp__46:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge16 = phi i32 [ 0, %%0 ], [ %%12, %%5  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge16_count);
...
printf("\n  %%6 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__21 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__21);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = srem i32 %%6, 8192, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  llvm_cbe_tmp__22 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__21) % ((signed int )8192u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__22));
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = trunc i32 %%7 to i16, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  llvm_cbe_tmp__23 = (unsigned short )((unsigned short )llvm_cbe_tmp__22&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add i16 %%8, -1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__24 = (unsigned short )((unsigned short )(((unsigned short )(llvm_cbe_tmp__23&65535ull)) + ((unsigned short )(((unsigned short )-1)&65535ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned short )(llvm_cbe_tmp__24&65535ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = sext i32 %%storemerge16 to i64, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
  llvm_cbe_tmp__25 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge16);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [8192 x i16]* %%in, i64 0, i64 %%10, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_66_count);
  llvm_cbe_tmp__26 = (signed short *)(&llvm_cbe_in[(((signed long long )llvm_cbe_tmp__25))
#ifdef AESL_BC_SIM
 % 8192
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed long long )llvm_cbe_tmp__25) < 8192 && "Write access out of array 'in' bound?");

#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%9, i16* %%11, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
  *llvm_cbe_tmp__26 = llvm_cbe_tmp__24;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = add nsw i32 %%storemerge16, 1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
  llvm_cbe_tmp__27 = (unsigned int )((unsigned int )(llvm_cbe_storemerge16&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__27&4294967295ull)));
  if (((llvm_cbe_tmp__27&4294967295U) == (8192u&4294967295U))) {
    llvm_cbe_storemerge25__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
    goto llvm_cbe__2e_preheader;
  } else {
    llvm_cbe_storemerge16__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__27;   /* for PHI node */
    goto llvm_cbe_tmp__46;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge25 = phi i32 [ %%15, %%.preheader ], [ 0, %%5  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge25_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i32 %%storemerge25 to i64, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_81_count);
  llvm_cbe_tmp__28 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge25);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds [8192 x i16]* %%out, i64 0, i64 %%13, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_82_count);
  llvm_cbe_tmp__29 = (signed short *)(&llvm_cbe_out[(((signed long long )llvm_cbe_tmp__28))
#ifdef AESL_BC_SIM
 % 8192
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed long long )llvm_cbe_tmp__28) < 8192 && "Write access out of array 'out' bound?");

#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 0, i16* %%14, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_83_count);
  *llvm_cbe_tmp__29 = ((unsigned short )0);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned short )0));
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add nsw i32 %%storemerge25, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_84_count);
  llvm_cbe_tmp__30 = (unsigned int )((unsigned int )(llvm_cbe_storemerge25&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__30&4294967295ull)));
  if (((llvm_cbe_tmp__30&4294967295U) == (8192u&4294967295U))) {
    goto llvm_cbe_tmp__47;
  } else {
    llvm_cbe_storemerge25__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__30;   /* for PHI node */
    goto llvm_cbe__2e_preheader;
  }
...
llvm_cbe_tmp__47:
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_lab3_z2_sw(i16* %%1, i16* %%2) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_97_count);
...
llvm_cbe_tmp__48:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge34 = phi i32 [ 0, %%16 ], [ %%25, %%17  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge34_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = sext i32 %%storemerge34 to i64, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_110_count);
  llvm_cbe_tmp__31 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge34);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = getelementptr inbounds [8192 x i16]* %%in, i64 0, i64 %%18, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_111_count);
  llvm_cbe_tmp__32 = (signed short *)(&llvm_cbe_in[(((signed long long )llvm_cbe_tmp__31))
#ifdef AESL_BC_SIM
 % 8192
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__31) < 8192)) fprintf(stderr, "%s:%d: warning: Read access out of array 'in' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i16* %%19, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_112_count);
  llvm_cbe_tmp__33 = (unsigned short )*llvm_cbe_tmp__32;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = sext i16 %%20 to i64, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__34 = (unsigned long long )((signed long long )(signed short )llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = getelementptr inbounds [8192 x i16]* %%actual_out, i64 0, i64 %%21, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_114_count);
  llvm_cbe_tmp__35 = (signed short *)(&llvm_cbe_actual_out[(((signed long long )llvm_cbe_tmp__34))
#ifdef AESL_BC_SIM
 % 8192
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__34) < 8192)) fprintf(stderr, "%s:%d: warning: Read access out of array 'actual_out' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = load i16* %%22, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_115_count);
  llvm_cbe_tmp__36 = (unsigned short )*llvm_cbe_tmp__35;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = add i16 %%23, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_116_count);
  llvm_cbe_tmp__37 = (unsigned short )((unsigned short )(((unsigned short )(llvm_cbe_tmp__36&65535ull)) + ((unsigned short )(((unsigned short )1)&65535ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned short )(llvm_cbe_tmp__37&65535ull)));

#ifdef AESL_BC_SIM
  assert(((signed long long )llvm_cbe_tmp__34) < 8192 && "Write access out of array 'actual_out' bound?");

#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%24, i16* %%22, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_117_count);
  *llvm_cbe_tmp__35 = llvm_cbe_tmp__37;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add nsw i32 %%storemerge34, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_118_count);
  llvm_cbe_tmp__38 = (unsigned int )((unsigned int )(llvm_cbe_storemerge34&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__38&4294967295ull)));
  if (((llvm_cbe_tmp__38&4294967295U) == (8192u&4294967295U))) {
    goto llvm_cbe_tmp__49;
  } else {
    llvm_cbe_storemerge34__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__38;   /* for PHI node */
    goto llvm_cbe_tmp__48;
  }
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 @arentEqual(i16* %%2, i16* %%3), !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_131_count);
  llvm_cbe_tmp__39 = (unsigned int )arentEqual((signed short *)llvm_cbe_tmp__18, (signed short *)llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = call i64 @fwrite(i8* getelementptr inbounds ([30 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64 29, i64 1, %%struct._iobuf* %%31), !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_139_count);
...
llvm_cbe_tmp__51:
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_141_count);
  llvm_cbe_tmp__43 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__43);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = getelementptr inbounds %%struct._iobuf* %%34, i64 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_142_count);
  llvm_cbe_tmp__44 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__43[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = call i64 @fwrite(i8* getelementptr inbounds ([30 x i8]* @aesl_internal_.str2, i64 0, i64 0), i64 29, i64 1, %%struct._iobuf* %%35), !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_143_count);
