...
architecture behav of lab4_z1 is 
    ...
    signal add_ln9_fu_127_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln9_reg_179 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal add_ln12_fu_148_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln12_reg_207 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln9_fu_115_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln12_fu_137_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln12_fu_142_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln9_fu_121_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                resultVecror_arr_addr_reg_189 <= zext_ln9_fu_115_p1(2 - 1 downto 0);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln9_fu_121_p2, ap_CS_fsm_state4, icmp_ln12_fu_142_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln9_fu_121_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_state4 => 
                if (((icmp_ln12_fu_142_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
    ...
    add_ln12_fu_148_p2 <= std_logic_vector(unsigned(j_reg_85) + unsigned(ap_const_lv3_1));
    add_ln9_fu_127_p2 <= std_logic_vector(unsigned(i_fu_42) + unsigned(ap_const_lv3_1));
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state2, icmp_ln9_fu_121_p2)
    begin
        if (((icmp_ln9_fu_121_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln9_fu_121_p2)
    begin
        if (((icmp_ln9_fu_121_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    firstVector_arr_address0 <= zext_ln12_fu_137_p1(2 - 1 downto 0);
    ...
    icmp_ln12_fu_142_p2 <= "1" when (j_reg_85 = ap_const_lv3_4) else "0";
    icmp_ln9_fu_121_p2 <= "1" when (i_fu_42 = ap_const_lv3_4) else "0";

    resultVecror_arr_address0_assign_proc : process(ap_CS_fsm_state2, resultVecror_arr_addr_reg_189, ap_CS_fsm_state4, zext_ln9_fu_115_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            resultVecror_arr_address0 <= resultVecror_arr_addr_reg_189;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            resultVecror_arr_address0 <= zext_ln9_fu_115_p1(2 - 1 downto 0);
        else 
    ...
    resultVecror_arr_we0_assign_proc : process(ap_CS_fsm_state4, icmp_ln12_fu_142_p2)
    begin
        if (((icmp_ln12_fu_142_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    secondVector_arr_address0 <= zext_ln9_fu_115_p1(2 - 1 downto 0);
    ...
    zext_ln12_fu_137_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_85),64));
    zext_ln9_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_42),64));
end behav;
