...
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i32* %%3, align 4, !dbg !3 for 0x%I64xth hint within @split  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__5 = (unsigned int )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds i32* %%out2, i64 %%2, !dbg !3 for 0x%I64xth hint within @split  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__6 = (signed int *)(&llvm_cbe_out2[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%6, i32* %%7, align 4, !dbg !3 for 0x%I64xth hint within @split  --> \n", ++aesl_llvm_cbe_23_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = sext i32 %%storemerge23 to i64, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_87_count);
  llvm_cbe_tmp__25 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge23);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = getelementptr inbounds [16384 x i32]* %%temp3, i64 0, i64 %%19, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_88_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i32* %%20, align 4, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_89_count);
  llvm_cbe_tmp__27 = (unsigned int )*llvm_cbe_tmp__26;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = mul nsw i32 %%21, 33, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_90_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = getelementptr inbounds i32* %%data_out2, i64 %%19, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_91_count);
  llvm_cbe_tmp__29 = (signed int *)(&llvm_cbe_data_out2[(((signed long long )llvm_cbe_tmp__25))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__25));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%22, i32* %%23, align 4, !dbg !4 for 0x%I64xth hint within @foo_m  --> \n", ++aesl_llvm_cbe_92_count);
