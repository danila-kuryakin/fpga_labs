...
# 2 "<built-in>" 2
# 1 "lab1_z2/source/lab1_z2.c" 2
# 1 "lab1_z2/source/lab1_z2.h" 1


typedef short din_type;
typedef int dout_type;

__attribute__((sdx_kernel("lab1_z2", 0))) void lab1_z2(din_type inArr[3], din_type a,
  din_type b, din_type c, dout_type outArr[3]);
# 2 "lab1_z2/source/lab1_z2.c" 2

__attribute__((sdx_kernel("lab1_z2", 0))) void lab1_z2(din_type inArr[3], din_type a,
  din_type b, din_type c, dout_type outArr[3])
{_ssdm_SpecArrayDimSize(inArr, 3);_ssdm_SpecArrayDimSize(outArr, 3);
#pragma HLSDIRECTIVE TOP name=lab1_z2
# 5 "lab1_z2/source/lab1_z2.c"

 din_type x;
 dout_type y;
 VITIS_LOOP_8_1: for(int i = 0; i < 3; i++)
 {
