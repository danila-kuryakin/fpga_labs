...
signed int apatb_lab1_z1_sw(signed short , signed short , signed short , signed short );
...
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = tail call i32 @apatb_lab1_z1_sw(i16 signext %%3, i16 signext %%6, i16 signext %%9, i16 signext %%12) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__13 = (unsigned int ) /*tail*/ apatb_lab1_z1_sw(llvm_cbe_tmp__3, llvm_cbe_tmp__6, llvm_cbe_tmp__9, llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = tail call i32 @apatb_lab1_z1_sw(i16 signext %%30, i16 signext %%33, i16 signext %%36, i16 signext %%39) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_90_count);
  llvm_cbe_tmp__37 = (unsigned int ) /*tail*/ apatb_lab1_z1_sw(llvm_cbe_tmp__27, llvm_cbe_tmp__30, llvm_cbe_tmp__33, llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__68);
if (AESL_DEBUG_TRACE)
printf("\n  %%78 = tail call i32 @apatb_lab1_z1_sw(i16 signext %%68, i16 signext %%71, i16 signext %%74, i16 signext %%77) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_156_count);
  llvm_cbe_tmp__69 = (unsigned int ) /*tail*/ apatb_lab1_z1_sw(llvm_cbe_tmp__59, llvm_cbe_tmp__62, llvm_cbe_tmp__65, llvm_cbe_tmp__68);
if (AESL_DEBUG_TRACE) {
