...
wire   [0:0] icmp_ln8_fu_274_p2;
reg   [0:0] icmp_ln8_reg_356_pp0_iter1_reg;
reg   [0:0] icmp_ln8_reg_356_pp0_iter2_reg;
...
wire  signed [16:0] sext_ln8_fu_296_p1;
...
wire   [16:0] ap_phi_reg_pp0_iter0_sext_ln8_phi_reg_220;
reg   [16:0] ap_phi_reg_pp0_iter1_sext_ln8_phi_reg_220;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln8_reg_356 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        do_init_reg_129 <= 1'd0;
    end else if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln8_reg_356 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        resultVecror_arr_addr_reg_350 <= zext_ln8_fu_268_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln8_reg_356_pp0_iter2_reg == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_180)) begin
        if ((icmp_ln8_reg_356 == 1'd1)) begin
            ap_phi_mux_i1_phi_fu_149_p6 = 2'd0;
        end else if ((icmp_ln8_reg_356 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln8_reg_356 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign ap_phi_reg_pp0_iter0_sext_ln8_phi_reg_220 = 'bx;
...
assign icmp_ln8_fu_274_p2 = ((ap_phi_mux_i1_phi_fu_149_p6 == 2'd3) ? 1'b1 : 1'b0);

assign resultVecror_arr_address0 = resultVecror_arr_addr_reg_350_pp0_iter2_reg;

assign resultVecror_arr_address1 = zext_ln8_fu_268_p1;

assign resultVecror_arr_d0 = grp_fu_325_p4;

assign secondVector_arr_address0 = zext_ln8_fu_268_p1;

assign sext_ln8_fu_296_p1 = $signed(firstVector_arr_q0);
...
assign tmp5_fu_313_p2 = (ap_phi_reg_pp0_iter1_firstVector_arr_load_2_cast_phi_reg_232 + ap_phi_reg_pp0_iter1_sext_ln8_phi_reg_220);

assign zext_ln8_fu_268_p1 = ap_phi_mux_i1_phi_fu_149_p6;
