...
void apatb_lab1_z2_sw(signed short *, signed short , signed short , signed short , signed int *);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str1[34] = "--------------Pass!-------------\n";
static  char aesl_internal__OC_str2[33] = "-------------Fail!-------------\n";
static  char aesl_internal__OC_str[43] = "ERROR: expected=%d actual=%d for ROW: %d \n";
...
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%13, i8* getelementptr inbounds ([43 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%14, i32 %%15, i32 %%storemerge) nounwind, !dbg !3 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_31_count);
...
signed int main(void) {
  static  unsigned long long aesl_llvm_cbe_inArr_count = 0;
  signed short llvm_cbe_inArr[3];    /* Address-exposed local */
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [3 x i16]* %%inArr, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__15 = (signed short *)(&llvm_cbe_inArr[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [3 x i32]* %%actualArr, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__16 = (signed int *)(&llvm_cbe_actualArr[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [3 x i32]* %%expectedArr, i64 0, i64 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__17 = (signed int *)(&llvm_cbe_expectedArr[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
llvm_cbe_tmp__65:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge5 = phi i32 [ 0, %%0 ], [ %%46, %%4  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge5_count);
...
printf("\n  %%6 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__19 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__19);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = srem i32 %%6, 100, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__20 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__19) % ((signed int )100u)));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%9 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__22 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__22);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = srem i32 %%9, 100, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_55_count);
  llvm_cbe_tmp__23 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__22) % ((signed int )100u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__23));
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = trunc i32 %%10 to i16, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_56_count);
  llvm_cbe_tmp__24 = (unsigned short )((unsigned short )llvm_cbe_tmp__23&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__25 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__25);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = srem i32 %%12, 100, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_71_count);
  llvm_cbe_tmp__28 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__28);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = srem i32 %%15, 1000, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_72_count);
  llvm_cbe_tmp__29 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__28) % ((signed int )1000u)));
if (AESL_DEBUG_TRACE)
...
#ifdef AESL_BC_SIM
  assert(((signed long long )0ull) < 3 && "Write access out of array 'inArr' bound?");

#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%17, i16* %%1, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* %%2, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_75_count);
  *llvm_cbe_tmp__16 = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_81_count);
  llvm_cbe_tmp__31 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__31);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = srem i32 %%18, 1000, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_82_count);
  llvm_cbe_tmp__32 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__31) % ((signed int )1000u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__32));
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = trunc i32 %%19 to i16, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_83_count);
  llvm_cbe_tmp__33 = (unsigned short )((unsigned short )llvm_cbe_tmp__32&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = getelementptr inbounds [3 x i16]* %%inArr, i64 0, i64 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_84_count);
  llvm_cbe_tmp__34 = (signed short *)(&llvm_cbe_inArr[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed long long )1ull) < 3 && "Write access out of array 'inArr' bound?");
...
printf("\n  %%22 = getelementptr inbounds [3 x i32]* %%actualArr, i64 0, i64 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_86_count);
  llvm_cbe_tmp__35 = (signed int *)(&llvm_cbe_actualArr[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_93_count);
  llvm_cbe_tmp__36 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__36);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = srem i32 %%23, 1000, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_94_count);
  llvm_cbe_tmp__37 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__36) % ((signed int )1000u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__37));
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = trunc i32 %%24 to i16, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_95_count);
  llvm_cbe_tmp__38 = (unsigned short )((unsigned short )llvm_cbe_tmp__37&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = getelementptr inbounds [3 x i16]* %%inArr, i64 0, i64 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_96_count);
  llvm_cbe_tmp__39 = (signed short *)(&llvm_cbe_inArr[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#ifdef AESL_BC_SIM
  assert(((signed long long )2ull) < 3 && "Write access out of array 'inArr' bound?");

#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%25, i16* %%26, align 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_97_count);
  *llvm_cbe_tmp__39 = llvm_cbe_tmp__38;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = getelementptr inbounds [3 x i32]* %%actualArr, i64 0, i64 2, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_98_count);
  llvm_cbe_tmp__40 = (signed int *)(&llvm_cbe_actualArr[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 0, i32* %%27, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_99_count);
  *llvm_cbe_tmp__40 = 0u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_lab1_z2_sw(i16* %%1, i16 signext %%8, i16 signext %%11, i16 signext %%14, i32* %%2) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_105_count);
  apatb_lab1_z2_sw((signed short *)llvm_cbe_tmp__15, llvm_cbe_tmp__21, llvm_cbe_tmp__24, llvm_cbe_tmp__27, (signed int *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = sext i16 %%8 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_111_count);
  llvm_cbe_tmp__41 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = sext i16 %%11 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_112_count);
  llvm_cbe_tmp__42 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__42);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = sext i16 %%14 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__43 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__43);
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = add i32 %%29, %%28, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_114_count);
  llvm_cbe_tmp__44 = (unsigned int )((unsigned int )(llvm_cbe_tmp__42&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__41&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__44&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = add i32 %%31, %%30, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_115_count);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )0ull) < 3)) fprintf(stderr, "%s:%d: warning: Read access out of array 'inArr' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = load i16* %%1, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_116_count);
  llvm_cbe_tmp__46 = (unsigned short )*llvm_cbe_tmp__15;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = sext i16 %%33 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__47 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__47);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = add i32 %%32, %%34, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_118_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%35, i32* %%3, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_119_count);
  *llvm_cbe_tmp__17 = llvm_cbe_tmp__48;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__48);

#ifdef AESL_BC_SIM
  if (!(((signed long long )1ull) < 3)) fprintf(stderr, "%s:%d: warning: Read access out of array 'inArr' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = load i16* %%21, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_125_count);
  llvm_cbe_tmp__49 = (unsigned short )*llvm_cbe_tmp__34;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__49);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = sext i16 %%36 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_126_count);
  llvm_cbe_tmp__50 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__49);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__50);
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = add i32 %%32, %%37, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_127_count);
  llvm_cbe_tmp__51 = (unsigned int )((unsigned int )(llvm_cbe_tmp__45&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__50&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__51&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds [3 x i32]* %%expectedArr, i64 0, i64 1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_128_count);
  llvm_cbe_tmp__52 = (signed int *)(&llvm_cbe_expectedArr[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%38, i32* %%39, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_129_count);
  *llvm_cbe_tmp__52 = llvm_cbe_tmp__51;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__51);

#ifdef AESL_BC_SIM
  if (!(((signed long long )2ull) < 3)) fprintf(stderr, "%s:%d: warning: Read access out of array 'inArr' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = load i16* %%26, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_135_count);
  llvm_cbe_tmp__53 = (unsigned short )*llvm_cbe_tmp__39;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__53);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = sext i16 %%40 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_136_count);
  llvm_cbe_tmp__54 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__53);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__54);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = add i32 %%32, %%41, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_137_count);
  llvm_cbe_tmp__55 = (unsigned int )((unsigned int )(llvm_cbe_tmp__45&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__54&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__55&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = getelementptr inbounds [3 x i32]* %%expectedArr, i64 0, i64 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_138_count);
  llvm_cbe_tmp__56 = (signed int *)(&llvm_cbe_expectedArr[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%42, i32* %%43, align 4, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_139_count);
  *llvm_cbe_tmp__56 = llvm_cbe_tmp__55;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__55);
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = call i32 @arentEqual(i32* %%3, i32* %%2), !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_145_count);
  llvm_cbe_tmp__57 = (unsigned int )arentEqual((signed int *)llvm_cbe_tmp__17, (signed int *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__57);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%45, i32 %%5, i32 1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (unsigned int )((((llvm_cbe_tmp__57&4294967295U) == (0u&4294967295U))) ? ((unsigned int )llvm_cbe_tmp__18) : ((unsigned int )1u));
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = add nsw i32 %%storemerge5, 1, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_147_count);
  llvm_cbe_tmp__58 = (unsigned int )((unsigned int )(llvm_cbe_storemerge5&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__58&4294967295ull)));
  if (((llvm_cbe_tmp__58&4294967295U) == (3u&4294967295U))) {
    goto llvm_cbe_tmp__66;
  } else {
    llvm_cbe_storemerge5__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__58;   /* for PHI node */
    llvm_cbe_tmp__18__PHI_TEMPORARY = (unsigned int )llvm_cbe__2e_;   /* for PHI node */
    goto llvm_cbe_tmp__65;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = call i64 @fwrite(i8* getelementptr inbounds ([34 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64 33, i64 1, %%struct._iobuf* %%51), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_156_count);
  fwrite(( char *)((&aesl_internal__OC_str1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 34
#endif
])), 33ull, 1ull, (l_struct_OC__iobuf *)llvm_cbe_tmp__60);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__68:
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_158_count);
  llvm_cbe_tmp__62 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__62);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = getelementptr inbounds %%struct._iobuf* %%54, i64 2, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_159_count);
  llvm_cbe_tmp__63 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__62[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = call i64 @fwrite(i8* getelementptr inbounds ([33 x i8]* @aesl_internal_.str2, i64 0, i64 0), i64 32, i64 1, %%struct._iobuf* %%55), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_160_count);
  fwrite(( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 33
#endif
])), 32ull, 1ull, (l_struct_OC__iobuf *)llvm_cbe_tmp__63);
if (AESL_DEBUG_TRACE) {
