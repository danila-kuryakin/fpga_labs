...
// ==============================================================
# 1 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c" 2
...
# 2 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c" 2
# 1 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1.h" 1
typedef int int_arr;



void split(int_arr in[16384], int_arr out1[16384], int_arr out2[16384]);
# 3 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c" 2

void initialize_int_arr(int_arr temp_arr[16384])
{
    for (int i = 0; i < 16384; i++)
        temp_arr[i] = 0;
}

void check_func(int check_in1[16384], int check_in2[16384], int scale, int foo_m_out1[16384], int foo_m_out2[16384])
{
...
int arentEqual(int_arr foo_m_in[16384], int_arr check_in1[16384], int_arr check_in2[16384])
{
 for (int i = 0; i < 16384; i++)
 {
  if (foo_m_in[i] != check_in1[i] || check_in1[i] != check_in2[i])
  {
   fprintf((&__iob_func()[1]), " ERROR: actual in1 = %d actual in2 = %d; expected in = %d\n",
...
#endif
int apatb_foo_m_sw();
# 39 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c"
int main()
{
    int pass = 0;

    int_arr scale, foo_m_in[16384], foo_m_out1[16384], foo_m_out2[16384], check_in1[16384], check_in2[16384];
...
#ifndef HLS_FASTSIM
#define foo_m apatb_foo_m_sw
#endif
# 61 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c"
...
#endif
# 74 "D:/Labs/3sem/FPGA/lab5_z1/source/lab5_z1_test.c"
