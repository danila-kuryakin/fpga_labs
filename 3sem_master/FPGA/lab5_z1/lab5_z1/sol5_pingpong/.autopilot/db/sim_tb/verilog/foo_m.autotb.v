...
`define AUTOTB_TVIN_data_in  "./c.foo_m.autotvin_data_in.dat"
`define AUTOTB_TVIN_scale  "./c.foo_m.autotvin_scale.dat"
`define AUTOTB_TVIN_data_out1  "./c.foo_m.autotvin_data_out1.dat"
`define AUTOTB_TVIN_data_out2  "./c.foo_m.autotvin_data_out2.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "./rtl.foo_m.autotvin_data_in.dat"
`define AUTOTB_TVIN_scale_out_wrapc  "./rtl.foo_m.autotvin_scale.dat"
`define AUTOTB_TVIN_data_out1_out_wrapc  "./rtl.foo_m.autotvin_data_out1.dat"
`define AUTOTB_TVIN_data_out2_out_wrapc  "./rtl.foo_m.autotvin_data_out2.dat"
`define AUTOTB_TVOUT_data_out1  "./c.foo_m.autotvout_data_out1.dat"
`define AUTOTB_TVOUT_data_out2  "./c.foo_m.autotvout_data_out2.dat"
`define AUTOTB_TVOUT_data_out1_out_wrapc  "./impl_rtl.foo_m.autotvout_data_out1.dat"
`define AUTOTB_TVOUT_data_out2_out_wrapc  "./impl_rtl.foo_m.autotvout_data_out2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 163845;
...
wire  data_in_ce0;
wire [31 : 0] data_in_d0;
wire [31 : 0] data_in_q0;
wire  data_in_we0;
wire [13 : 0] data_in_address1;
wire  data_in_ce1;
wire [31 : 0] data_in_d1;
wire [31 : 0] data_in_q1;
wire  data_in_we1;
wire [31 : 0] scale;
wire [13 : 0] data_out1_address0;
wire  data_out1_ce0;
wire [31 : 0] data_out1_d0;
wire [31 : 0] data_out1_q0;
wire  data_out1_we0;
wire [13 : 0] data_out1_address1;
wire  data_out1_ce1;
wire [31 : 0] data_out1_d1;
wire [31 : 0] data_out1_q1;
wire  data_out1_we1;
wire [13 : 0] data_out2_address0;
wire  data_out2_ce0;
wire [31 : 0] data_out2_d0;
wire [31 : 0] data_out2_q0;
wire  data_out2_we0;
wire [13 : 0] data_out2_address1;
wire  data_out2_ce1;
wire [31 : 0] data_out2_d1;
wire [31 : 0] data_out2_q1;
wire  data_out2_we1;
wire ap_start;
wire ap_done;
wire ap_ready;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .data_in_d0(data_in_d0),
    .data_in_q0(data_in_q0),
    .data_in_we0(data_in_we0),
    .data_in_address1(data_in_address1),
    .data_in_ce1(data_in_ce1),
    .data_in_d1(data_in_d1),
    .data_in_q1(data_in_q1),
    .data_in_we1(data_in_we1),
    .scale(scale),
    .data_out1_address0(data_out1_address0),
    .data_out1_ce0(data_out1_ce0),
    .data_out1_d0(data_out1_d0),
    .data_out1_q0(data_out1_q0),
    .data_out1_we0(data_out1_we0),
    .data_out1_address1(data_out1_address1),
    .data_out1_ce1(data_out1_ce1),
    .data_out1_d1(data_out1_d1),
    .data_out1_q1(data_out1_q1),
    .data_out1_we1(data_out1_we1),
    .data_out2_address0(data_out2_address0),
    .data_out2_ce0(data_out2_ce0),
    .data_out2_d0(data_out2_d0),
    .data_out2_q0(data_out2_q0),
    .data_out2_we0(data_out2_we0),
    .data_out2_address1(data_out2_address1),
    .data_out2_ce1(data_out2_ce1),
    .data_out2_d1(data_out2_d1),
    .data_out2_q1(data_out2_q1),
    .data_out2_we1(data_out2_we1),
    .ap_start(ap_start),
    .ap_done(ap_done),
    .ap_ready(ap_ready),
    .ap_idle(ap_idle));
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.foo_m.autotvout_data_out1.dat", "r");
    fp2 = $fopen("./impl_rtl.foo_m.autotvout_data_out1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.foo_m.autotvout_data_out1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.foo_m.autotvout_data_out1.dat\"!");
    else begin
        $display("Comparing rtl.foo_m.autotvout_data_out1.dat with impl_rtl.foo_m.autotvout_data_out1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.foo_m.autotvout_data_out2.dat", "r");
    fp2 = $fopen("./impl_rtl.foo_m.autotvout_data_out2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.foo_m.autotvout_data_out2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.foo_m.autotvout_data_out2.dat\"!");
    else begin
        $display("Comparing rtl.foo_m.autotvout_data_out2.dat with impl_rtl.foo_m.autotvout_data_out2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
