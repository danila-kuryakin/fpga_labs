...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "foo_m.autotvin.dat"
	set constFileTvOut       "foo_m.autotvout.dat"
	set constFileHdlTvIn     "foo_m.autohdltvin.dat"
	set constFileHdlTvOut    "foo_m.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
