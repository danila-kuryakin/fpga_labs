...
$(ObjDir)/lab4_z1_test.c_pre.c.tb.o : lab4_z1_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab4_z1_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lab4_z1.c_pre.c.tb.o : lab4_z1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab4_z1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
