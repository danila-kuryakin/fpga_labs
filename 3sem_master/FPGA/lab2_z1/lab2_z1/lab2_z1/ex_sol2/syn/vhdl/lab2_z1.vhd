...
architecture behav of lab2_z1 is 
    ...
    "lab2_z1_lab2_z1,hls_ip_2021_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.860000,HLS_SYN_LAT=19,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=266,HLS_SYN_LUT=125,HLS_VERSION=2021_2}";
    ...
    component lab2_z1_mul_16ns_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mul_16ns_32s_32_2_1_U1 : component lab2_z1_mul_16ns_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 16,
    ...
    icmp_ln6_fu_76_p2 <= "1" when (signed(zext_ln6_1_fu_72_p1) > signed(sext_ln6_reg_116)) else "0";
