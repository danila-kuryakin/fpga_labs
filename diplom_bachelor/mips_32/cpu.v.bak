...
// для ALU
reg [7:0] rf_read_data_1_E, rf_read_data_1_M, rf_read_data_1_W, rf_read_data_2_E;
reg [7:0] reg_rezult_M, reg_rezult_W;
reg [7:0] alu_word, alu_result;
wire [7:0] rf_data_1, rf_data_2, retunt_data_W_1, retunt_data_W_2, retunt_data_M_1, retunt_data_M_2;

reg [7:0] reg_write_data_dm_M, reg_write_data_dm_W;	 	
...
initial begin
	...
	rf_read_data_1_E <= 8'b0;
	rf_read_data_1_M <= 8'b0;
	rf_read_data_1_W <= 8'b0;
	rf_read_data_2_E <= 8'b0;
		
	reg_rezult_M <= 8'b0;
	reg_rezult_W <= 8'b0;
	
	reg_write_data_dm_W <= 8'b0;
end
