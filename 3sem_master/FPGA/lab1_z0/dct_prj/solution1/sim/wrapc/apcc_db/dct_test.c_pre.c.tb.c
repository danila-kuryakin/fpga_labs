...
void apatb_dct_sw(signed short *, signed short *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_dct_sw(i16* %%21, i16* %%22) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_112_count);
  apatb_dct_sw((signed short *)llvm_cbe_tmp__17, (signed short *)llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE) {
}
