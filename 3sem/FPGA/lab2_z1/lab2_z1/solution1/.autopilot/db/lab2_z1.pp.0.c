...
# 2 "<built-in>" 2
# 1 "lab2_z1/source/lab2_z1.c" 2
# 1 "lab2_z1/source/lab2_z1.h" 1


typedef short din_type;
typedef int dout_type;

__attribute__((sdx_kernel("lab2_z1", 0))) dout_type lab2_z1 (din_type in);
# 2 "lab2_z1/source/lab2_z1.c" 2

__attribute__((sdx_kernel("lab2_z1", 0))) dout_type lab2_z1 (din_type in)
{
#pragma HLSDIRECTIVE TOP name=lab2_z1
# 4 "lab2_z1/source/lab2_z1.c"

 dout_type res = 1;
 VITIS_LOOP_6_1: for(int i = 1; i <= in; i++)
 {
  res = res * i;
 }
 return res;
