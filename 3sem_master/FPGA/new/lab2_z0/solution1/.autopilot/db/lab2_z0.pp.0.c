...
# 2 "<built-in>" 2
# 1 "lab2_z0/source/lab2_z0.c" 2
# 1 "lab2_z0/source/lab2_z0.h" 1
...
__attribute__((sdx_kernel("lab2_z0", 0))) void lab2_z0 (din_type in_a[3], din_type in_b[3], dout_type res[3]);
# 2 "lab2_z0/source/lab2_z0.c" 2

__attribute__((sdx_kernel("lab2_z0", 0))) void lab2_z0 (din_type in_a[3], din_type in_b[3], dout_type res[3])
{_ssdm_SpecArrayDimSize(in_a, 3);_ssdm_SpecArrayDimSize(in_b, 3);_ssdm_SpecArrayDimSize(res, 3);
#pragma HLSDIRECTIVE TOP name=lab2_z0
# 4 "lab2_z0/source/lab2_z0.c"
