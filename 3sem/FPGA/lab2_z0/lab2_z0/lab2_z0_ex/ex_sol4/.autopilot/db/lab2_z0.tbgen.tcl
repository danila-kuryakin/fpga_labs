...
set Spec2ImplPortList { 
	in_a { ap_memory {  { in_a_address0 mem_address 1 2 }  { in_a_ce0 mem_ce 1 1 }  { in_a_q0 in_data 0 16 } } }
	in_b { ap_memory {  { in_b_address0 mem_address 1 2 }  { in_b_ce0 mem_ce 1 1 }  { in_b_q0 in_data 0 16 } } }
