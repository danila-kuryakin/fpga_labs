...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.foo_m.autotvin_data_in.dat"
         "c.foo_m.autotvin_scale.dat"
         "c.foo_m.autotvin_data_out1.dat"
         "c.foo_m.autotvin_data_out2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.foo_m.autotvout_data_out1.dat"
         "rtl.foo_m.autotvout_data_out2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
