...
port (
    ...
    out_ar_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
...
architecture behav of lab3_z2 is 
    ...
    "lab3_z2_lab3_z2,hls_ip_2021_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.757000,HLS_SYN_LAT=65537,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=50,HLS_SYN_LUT=114,HLS_VERSION=2021_2}";
    ...
    signal out_ar_addr_reg_113 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal i_fu_44 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln7_fu_81_p2 : STD_LOGIC_VECTOR (14 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                out_ar_addr_reg_113 <= zext_ln11_fu_92_p1(14 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln7_fu_81_p2 <= std_logic_vector(unsigned(i_fu_44) + unsigned(ap_const_lv15_1));
    ...
    icmp_ln7_fu_75_p2 <= "1" when (i_fu_44 = ap_const_lv15_4000) else "0";
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            ...
            out_ar_address0 <= zext_ln11_fu_92_p1(14 - 1 downto 0);
        else 
            out_ar_address0 <= "XXXXXXXXXXXXXX";
        end if; 
    end process;
