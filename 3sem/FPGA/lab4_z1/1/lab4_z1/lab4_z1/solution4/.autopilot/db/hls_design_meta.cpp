...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("firstVector_arr_address1", 2, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("firstVector_arr_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("firstVector_arr_q1", 16, hls_in, 0, "ap_memory", "in_data", 1),
	...
	Port_Property("resultVecror_arr_address1", 2, hls_out, 2, "ap_memory", "MemPortADDR2", 1),
	Port_Property("resultVecror_arr_ce1", 1, hls_out, 2, "ap_memory", "MemPortCE2", 1),
	Port_Property("resultVecror_arr_q1", 32, hls_in, 2, "ap_memory", "MemPortDOUT2", 1),
};
