...
entity lab3_z1_regslice_forward is
...
architecture behav of lab3_z1_regslice_forward is
    ...
    component lab3_z1_regslice_obuf IS
    generic (
        W : INTEGER );
    port (
        clk : IN STD_LOGIC;
...
begin
    ...
    regslice_obuf_inst : component lab3_z1_regslice_obuf
    generic map (
        W => W)
    port map (
        clk => ap_clk,
...
entity lab3_z1_regslice_forward_w1 is
...
architecture behav of lab3_z1_regslice_forward_w1 is
...
entity lab3_z1_regslice_obuf is
...
architecture behav of lab3_z1_regslice_obuf is
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';
