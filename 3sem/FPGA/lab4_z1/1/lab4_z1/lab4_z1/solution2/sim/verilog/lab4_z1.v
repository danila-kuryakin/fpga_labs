...
wire   [63:0] zext_ln9_fu_103_p1;
reg   [2:0] i_fu_42;
wire   [2:0] add_ln9_fu_97_p2;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_42 <= 3'd0;
    end else if (((icmp_ln9_fu_91_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln9_fu_91_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln9_fu_91_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        resultVecror_arr_address0 = zext_ln9_fu_103_p1;
...
assign add_ln9_fu_97_p2 = (i_fu_42 + 3'd1);
...
assign icmp_ln9_fu_91_p2 = ((i_fu_42 == 3'd4) ? 1'b1 : 1'b0);

assign resultVecror_arr_d0 = grp_lab4_z1_Pipeline_L1_fu_72_resultVecror_arr_d0;

assign secondVector_arr_address0 = zext_ln9_fu_103_p1;

assign trunc_ln6_fu_109_p1 = i_fu_42[1:0];

assign zext_ln9_fu_103_p1 = i_fu_42;
