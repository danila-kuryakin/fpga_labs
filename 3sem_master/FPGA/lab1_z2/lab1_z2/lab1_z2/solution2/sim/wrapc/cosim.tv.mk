...
$(ObjDir)/lab1_z2_test.c_pre.c.tb.o : lab1_z2_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab1_z2_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lab1_z2.c_pre.c.tb.o : lab1_z2.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab1_z2.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
