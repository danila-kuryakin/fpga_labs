...
set portList { 
	...
	{ temp1_address0 sc_out sc_lv 14 signal 2 } 
	{ temp1_ce0 sc_out sc_logic 1 signal 2 } 
	{ temp1_we0 sc_out sc_logic 1 signal 2 } 
	{ temp1_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "temp1", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "temp1", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0"}],
		"Loop" : [
...
set Spec2ImplPortList { 
	...
	temp1 { ap_memory {  { temp1_address0 mem_address 1 14 }  { temp1_ce0 mem_ce 1 1 }  { temp1_we0 mem_we 1 1 }  { temp1_d0 mem_din 1 32 } } }
}
