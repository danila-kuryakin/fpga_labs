...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lab2_z0.autotvin.dat"
	set constFileTvOut       "lab2_z0.autotvout.dat"
	set constFileHdlTvIn     "lab2_z0.autohdltvin.dat"
	set constFileHdlTvOut    "lab2_z0.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
