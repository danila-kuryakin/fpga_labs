...
$(ObjDir)/lab2_z1_test.c_pre.c.tb.o : lab2_z1_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab2_z1_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lab2_z1.c_pre.c.tb.o : lab2_z1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab2_z1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
