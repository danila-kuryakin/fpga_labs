...
void lab1_z2(signed short *, signed short , signed short , signed short , signed int *);
...
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @lab1_z2(i16* %%1, i16 signext %%8, i16 signext %%11, i16 signext %%14, i32* %%2) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_105_count);
  lab1_z2((signed short *)llvm_cbe_tmp__15, llvm_cbe_tmp__21, llvm_cbe_tmp__24, llvm_cbe_tmp__27, (signed int *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
