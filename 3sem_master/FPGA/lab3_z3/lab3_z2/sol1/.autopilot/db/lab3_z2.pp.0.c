...
# 2 "<built-in>" 2
# 1 "./source/lab3_z2.c" 2
# 1 "./source/lab3_z2.h" 1



typedef short data_sc;

__attribute__((sdx_kernel("lab3_z2", 0))) void lab3_z2 (data_sc inA_ar[16384], data_sc out_ar[16384]);
# 2 "./source/lab3_z2.c" 2

__attribute__((sdx_kernel("lab3_z2", 0))) void lab3_z2(data_sc inA_ar[16384], data_sc out_ar[16384])
{_ssdm_SpecArrayDimSize(inA_ar, 16384);_ssdm_SpecArrayDimSize(out_ar, 16384);
#pragma HLSDIRECTIVE INTERFACE ap_fifo port=inA_ar
# 4 "./source/lab3_z2.c"
...
# 4 "./source/lab3_z2.c"
 ...
 int i;
 data_sc temp;
 VITIS_LOOP_7_1: for (i = 0; i < 16384; i++)
 {
