...
printf("\n\{ BEGIN @lab1_z2\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i16 %%a to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__1 = (unsigned int )((signed int )(signed short )llvm_cbe_a);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i16 %%b to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__2 = (unsigned int )((signed int )(signed short )llvm_cbe_b);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i16 %%c to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__3 = (unsigned int )((signed int )(signed short )llvm_cbe_c);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = add i32 %%2, %%1, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_19_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add i32 %%4, %%3, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_20_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i16* %%inArr, align 2, !dbg !2 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__6 = (unsigned short )*llvm_cbe_inArr;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i16 %%6 to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__7 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = add i32 %%5, %%7, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_25_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%8, i32* %%outArr, align 4, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_28_count);
  *llvm_cbe_outArr = llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds i16* %%inArr, i64 1, !dbg !2 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__9 = (signed short *)(&llvm_cbe_inArr[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i16* %%9, align 2, !dbg !2 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__10 = (unsigned short )*llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = sext i16 %%10 to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__11 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = add i32 %%5, %%11, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_39_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = getelementptr inbounds i32* %%outArr, i64 1, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__13 = (signed int *)(&llvm_cbe_outArr[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%12, i32* %%13, align 4, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_43_count);
  *llvm_cbe_tmp__13 = llvm_cbe_tmp__12;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds i16* %%inArr, i64 2, !dbg !2 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__14 = (signed short *)(&llvm_cbe_inArr[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load i16* %%14, align 2, !dbg !2 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_50_count);
  llvm_cbe_tmp__15 = (unsigned short )*llvm_cbe_tmp__14;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = sext i16 %%15 to i32, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_53_count);
  llvm_cbe_tmp__16 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add i32 %%5, %%16, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_54_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds i32* %%outArr, i64 2, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_57_count);
  llvm_cbe_tmp__18 = (signed int *)(&llvm_cbe_outArr[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%17, i32* %%18, align 4, !dbg !3 for 0x%I64xth hint within @lab1_z2  --> \n", ++aesl_llvm_cbe_58_count);
