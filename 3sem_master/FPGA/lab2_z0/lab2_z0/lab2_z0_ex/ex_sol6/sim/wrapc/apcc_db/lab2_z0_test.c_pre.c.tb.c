...
void apatb_lab2_z0_sw(signed short *, signed short *, signed int *);
...
printf("\n = 0x%X\n", 0u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_lab2_z0_sw(i16* %%1, i16* %%2, i32* %%3) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
  apatb_lab2_z0_sw((signed short *)llvm_cbe_tmp__15, (signed short *)llvm_cbe_tmp__16, (signed int *)llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE) {
}
