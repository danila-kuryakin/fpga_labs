...
signed int apatb_lab3_z1_sw(signed short , signed short , signed short *, signed int *);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 @apatb_lab3_z1_sw(i16 signext %%4, i16 signext %%8, i16* %%inC, i32* %%res) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  apatb_lab3_z1_sw(llvm_cbe_tmp__13, llvm_cbe_tmp__17, (signed short *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_res));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = call i32 @apatb_lab3_z1_sw(i16 signext %%25, i16 signext %%29, i16* %%inC, i32* %%res) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_115_count);
  apatb_lab3_z1_sw(llvm_cbe_tmp__33, llvm_cbe_tmp__37, (signed short *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_res));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = call i32 @apatb_lab3_z1_sw(i16 signext %%46, i16 signext %%50, i16* %%inC, i32* %%res) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_169_count);
  apatb_lab3_z1_sw(llvm_cbe_tmp__53, llvm_cbe_tmp__57, (signed short *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_res));
if (AESL_DEBUG_TRACE) {
