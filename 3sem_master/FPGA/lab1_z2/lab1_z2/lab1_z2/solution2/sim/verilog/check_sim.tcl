...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab1_z2.autotvin_inArr.dat"
         "c.lab1_z2.autotvin_a.dat"
         "c.lab1_z2.autotvin_b.dat"
         "c.lab1_z2.autotvin_c.dat"
         "c.lab1_z2.autotvin_outArr.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab1_z2.autotvout_outArr.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
