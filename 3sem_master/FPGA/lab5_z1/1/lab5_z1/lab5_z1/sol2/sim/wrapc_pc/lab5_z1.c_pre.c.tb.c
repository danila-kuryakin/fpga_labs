...
// ==============================================================
# 1 "D:/Labs/3sem/FPGA/lab5_z1/1/lab5_z1/source/lab5_z1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 365 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/Labs/3sem/FPGA/lab5_z1/1/lab5_z1/source/lab5_z1.c" 2
...
# 2 "D:/Labs/3sem/FPGA/lab5_z1/1/lab5_z1/source/lab5_z1.c" 2
...
# 3 "D:/Labs/3sem/FPGA/lab5_z1/1/lab5_z1/source/lab5_z1.c" 2
...
void foo_m(int data_in[16384], int scale, int data_out1[16384], int data_out2[16384])
{
...
extern "C"
#endif
void apatb_foo_m_ir(int *, int, int *, int *);
#ifdef __cplusplus
extern "C"
#endif
void foo_m_hw_stub(int *data_in, int scale, int *data_out1, int *data_out2){
...
extern "C"
#endif
void apatb_foo_m_sw(int *data_in, int scale, int *data_out1, int *data_out2){
apatb_foo_m_ir(data_in, scale, data_out1, data_out2);
return ;
}
#endif
# 45 "D:/Labs/3sem/FPGA/lab5_z1/1/lab5_z1/source/lab5_z1.c"
