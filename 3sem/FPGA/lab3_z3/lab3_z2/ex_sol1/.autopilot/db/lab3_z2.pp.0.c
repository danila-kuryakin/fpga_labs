...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Programs/Xilinx/VITIS_~1/2021.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h" 1
# 314 "C:/Programs/Xilinx/VITIS_~1/2021.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
...
__attribute__((sdx_kernel("lab3_z2", 0))) void lab3_z2 (data_sc inA_ar[4096], data_sc out_ar[4096]);
# 2 "./source/lab3_z2.c" 2

__attribute__((sdx_kernel("lab3_z2", 0))) void lab3_z2(data_sc inA_ar[4096], data_sc out_ar[4096])
{_ssdm_SpecArrayDimSize(inA_ar, 4096);_ssdm_SpecArrayDimSize(out_ar, 4096);
#pragma HLSDIRECTIVE TOP name=lab3_z2
# 4 "./source/lab3_z2.c"

 int i;
 data_sc temp;
 VITIS_LOOP_7_1: for (i = 0; i < 4096; i++)
 {
