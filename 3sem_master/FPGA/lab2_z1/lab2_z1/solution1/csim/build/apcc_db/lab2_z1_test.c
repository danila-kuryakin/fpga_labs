...
signed int lab2_z1(signed short );
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call i32 @lab2_z1(i16 signext %%4) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_47_count);
  llvm_cbe_tmp__13 = (unsigned int ) /*tail*/ lab2_z1(llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call i32 @lab2_z1(i16 signext %%16) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_73_count);
  llvm_cbe_tmp__24 = (unsigned int ) /*tail*/ lab2_z1(llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = tail call i32 @lab2_z1(i16 signext %%28) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_99_count);
  llvm_cbe_tmp__35 = (unsigned int ) /*tail*/ lab2_z1(llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE) {
