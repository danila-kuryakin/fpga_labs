...
set C_modelArgList {
	{ temp3 int 32 regular {fifo 0 volatile }  }
	{ data_out2 int 32 regular {array 16384 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "temp3", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ temp3_dout sc_in sc_lv 32 signal 0 } 
	{ temp3_empty_n sc_in sc_logic 1 signal 0 } 
	{ temp3_read sc_out sc_logic 1 signal 0 } 
	{ data_out2_address0 sc_out sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "temp3", "role": "dout" }} , 
 	{ "name": "temp3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "temp3", "role": "empty_n" }} , 
 	{ "name": "temp3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "temp3", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "temp3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	temp3 { ap_fifo {  { temp3_dout fifo_data 0 32 }  { temp3_empty_n fifo_status 0 1 }  { temp3_read fifo_update 1 1 } } }
