...
printf("\n  %%4 = sext i32 %%storemerge to i64, !dbg !5 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_169_count);
  llvm_cbe_tmp__37 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds i16* %%expected_ar, i64 %%4, !dbg !5 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_170_count);
  llvm_cbe_tmp__38 = (signed short *)(&llvm_cbe_expected_ar[(((signed long long )llvm_cbe_tmp__37))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__37));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i16* %%5, align 2, !dbg !5 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_171_count);
  llvm_cbe_tmp__39 = (unsigned short )*llvm_cbe_tmp__38;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds i16* %%actual_arr, i64 %%4, !dbg !5 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_172_count);
  llvm_cbe_tmp__40 = (signed short *)(&llvm_cbe_actual_arr[(((signed long long )llvm_cbe_tmp__37))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__37));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i16* %%7, align 2, !dbg !5 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_173_count);
  llvm_cbe_tmp__41 = (unsigned short )*llvm_cbe_tmp__40;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = add nsw i32 %%storemerge, 1, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_175_count);
  llvm_cbe_tmp__42 = (unsigned int )((unsigned int )(llvm_cbe_storemerge&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__42&4294967295ull)));
  if (((llvm_cbe_tmp__39&65535U) == (llvm_cbe_tmp__41&65535U))) {
    llvm_cbe_storemerge__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__42;   /* for PHI node */
    goto llvm_cbe_tmp__50;
  } else {
...
llvm_cbe_tmp__52:
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_178_count);
  llvm_cbe_tmp__43 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__43);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = getelementptr inbounds %%struct._iobuf* %%12, i64 1, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_179_count);
  llvm_cbe_tmp__44 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__43[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i16* %%7, align 2, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_180_count);
  llvm_cbe_tmp__45 = (unsigned short )*llvm_cbe_tmp__40;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__45);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = sext i16 %%14 to i32, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_181_count);
  llvm_cbe_tmp__46 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__45);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load i16* %%5, align 2, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_182_count);
  llvm_cbe_tmp__47 = (unsigned short )*llvm_cbe_tmp__38;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__47);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = sext i16 %%16 to i32, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_183_count);
  llvm_cbe_tmp__48 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__47);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__48);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%13, i8* getelementptr inbounds ([63 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%15, i32 %%17) nounwind, !dbg !6 for 0x%I64xth hint within @arentEqual  --> \n", ++aesl_llvm_cbe_184_count);
   /*tail*/ fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__44, ( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 63
#endif
...
signed int main(void) {
  ...
  unsigned short llvm_cbe_tmp__85;
  static  unsigned long long aesl_llvm_cbe_258_count = 0;
  signed short *llvm_cbe_tmp__86;
  ...
  l_struct_OC__iobuf *llvm_cbe_tmp__116;
  static  unsigned long long aesl_llvm_cbe_350_count = 0;
  l_struct_OC__iobuf *llvm_cbe_tmp__117;
...
printf("\n  %%1 = getelementptr inbounds [4 x i32]* %%actual_ar, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_197_count);
  llvm_cbe_tmp__53 = (signed int *)(&llvm_cbe_actual_ar[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%2 = getelementptr inbounds [4 x i16]* %%firstVector_arr, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_198_count);
  llvm_cbe_tmp__54 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%3 = getelementptr inbounds [4 x i16]* %%actual_arr, i64 0, i64 0, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_199_count);
  llvm_cbe_tmp__55 = (signed short *)(&llvm_cbe_actual_arr[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%4 = getelementptr inbounds [4 x i16]* %%expected_ar, i64 0, i64 0, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_200_count);
  llvm_cbe_tmp__56 = (signed short *)(&llvm_cbe_expected_ar[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  call void @initialize_int_arr(i32* %%1), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_201_count);
  initialize_int_arr((signed int *)llvm_cbe_tmp__53);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  store i16 %%7, i16* %%2, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_210_count);
  *llvm_cbe_tmp__54 = llvm_cbe_tmp__59;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__59);
if (AESL_DEBUG_TRACE)
...
printf("\n  store i16 %%10, i16* %%3, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_214_count);
  *llvm_cbe_tmp__55 = llvm_cbe_tmp__62;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__62);
if (AESL_DEBUG_TRACE)
...
printf("\n  %%14 = getelementptr inbounds [4 x i16]* %%firstVector_arr, i64 0, i64 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_223_count);
  llvm_cbe_tmp__66 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%18 = getelementptr inbounds [4 x i16]* %%actual_arr, i64 0, i64 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_228_count);
  llvm_cbe_tmp__70 = (signed short *)(&llvm_cbe_actual_arr[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%23 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_240_count);
  llvm_cbe_tmp__75 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__75);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = srem i32 %%23, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_241_count);
  llvm_cbe_tmp__76 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__75) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%26 = getelementptr inbounds [4 x i16]* %%actual_arr, i64 0, i64 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_243_count);
  llvm_cbe_tmp__78 = (signed short *)(&llvm_cbe_actual_arr[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%28 = srem i32 %%27, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_251_count);
  llvm_cbe_tmp__80 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__79) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__80));
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = trunc i32 %%28 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_252_count);
  llvm_cbe_tmp__81 = (unsigned short )((unsigned short )llvm_cbe_tmp__80&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__81);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = getelementptr inbounds [4 x i16]* %%firstVector_arr, i64 0, i64 3, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_253_count);
  llvm_cbe_tmp__82 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )3ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  %%31 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_255_count);
  llvm_cbe_tmp__83 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%33 = trunc i32 %%32 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_257_count);
  llvm_cbe_tmp__85 = (unsigned short )((unsigned short )llvm_cbe_tmp__84&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__85);
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = getelementptr inbounds [4 x i16]* %%actual_arr, i64 0, i64 3, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_258_count);
  llvm_cbe_tmp__86 = (signed short *)(&llvm_cbe_actual_arr[(((signed long long )3ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
printf("\n  call void @lab4_z1(i16* %%2, i16* %%3, i32* %%1) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_265_count);
  lab4_z1((signed short *)llvm_cbe_tmp__54, (signed short *)llvm_cbe_tmp__55, (signed int *)llvm_cbe_tmp__53);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @initialize_short_arr(i16* %%4), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_266_count);
  initialize_short_arr((signed short *)llvm_cbe_tmp__56);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @check_func(i16* %%2, i32* %%1, i16* %%4), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_267_count);
  check_func((signed short *)llvm_cbe_tmp__54, (signed int *)llvm_cbe_tmp__53, (signed short *)llvm_cbe_tmp__56);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = call i32 @arentEqual(i16* %%4, i16* %%3), !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_268_count);
  arentEqual((signed short *)llvm_cbe_tmp__56, (signed short *)llvm_cbe_tmp__55);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_281_count);
  llvm_cbe_tmp__88 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__88);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = srem i32 %%36, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_282_count);
  llvm_cbe_tmp__89 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__88) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__89));
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = trunc i32 %%37 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_283_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%38, i16* %%2, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_284_count);
  *llvm_cbe_tmp__54 = llvm_cbe_tmp__90;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__90);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_285_count);
  llvm_cbe_tmp__91 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__91);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = srem i32 %%39, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_286_count);
  llvm_cbe_tmp__92 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__91) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__92));
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = trunc i32 %%40 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_287_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%41, i16* %%3, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_288_count);
  *llvm_cbe_tmp__55 = llvm_cbe_tmp__93;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__93);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_294_count);
  llvm_cbe_tmp__94 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__94);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = srem i32 %%42, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_295_count);
  llvm_cbe_tmp__95 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__94) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__95));
if (AESL_DEBUG_TRACE)
printf("\n  %%44 = trunc i32 %%43 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_296_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%44, i16* %%14, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_297_count);
  *llvm_cbe_tmp__66 = llvm_cbe_tmp__96;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__96);
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_298_count);
  llvm_cbe_tmp__97 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__97);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = srem i32 %%45, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_299_count);
  llvm_cbe_tmp__98 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__97) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__98));
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = trunc i32 %%46 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_300_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%47, i16* %%18, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_301_count);
  *llvm_cbe_tmp__70 = llvm_cbe_tmp__99;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__99);
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_307_count);
  llvm_cbe_tmp__100 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__100);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = srem i32 %%48, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_308_count);
  llvm_cbe_tmp__101 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__100) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__101));
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = trunc i32 %%49 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_309_count);
  llvm_cbe_tmp__102 = (unsigned short )((unsigned short )llvm_cbe_tmp__101&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__102);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%50, i16* %%22, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_310_count);
  *llvm_cbe_tmp__74 = llvm_cbe_tmp__102;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__102);
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_311_count);
  llvm_cbe_tmp__103 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__103);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%52 = srem i32 %%51, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_312_count);
  llvm_cbe_tmp__104 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__103) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__104));
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = trunc i32 %%52 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_313_count);
  llvm_cbe_tmp__105 = (unsigned short )((unsigned short )llvm_cbe_tmp__104&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__105);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%53, i16* %%26, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_314_count);
  *llvm_cbe_tmp__78 = llvm_cbe_tmp__105;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__105);
if (AESL_DEBUG_TRACE)
printf("\n  %%54 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_320_count);
  llvm_cbe_tmp__106 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__106);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = srem i32 %%54, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_321_count);
  llvm_cbe_tmp__107 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__106) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__107));
if (AESL_DEBUG_TRACE)
printf("\n  %%56 = trunc i32 %%55 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_322_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%56, i16* %%30, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_323_count);
  *llvm_cbe_tmp__82 = llvm_cbe_tmp__108;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__108);
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = call i32 bitcast (i32 (...)* @rand to i32 ()*)() nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_324_count);
  llvm_cbe_tmp__109 = (unsigned int )rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__109);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%58 = srem i32 %%57, 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_325_count);
  llvm_cbe_tmp__110 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__109) % ((signed int )4u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__110));
if (AESL_DEBUG_TRACE)
printf("\n  %%59 = trunc i32 %%58 to i16, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_326_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%59, i16* %%34, align 2, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_327_count);
  *llvm_cbe_tmp__86 = llvm_cbe_tmp__111;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__111);
if (AESL_DEBUG_TRACE)
...
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = call i32 @arentEqual(i16* %%4, i16* %%3), !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_336_count);
  llvm_cbe_tmp__112 = (unsigned int )arentEqual((signed short *)llvm_cbe_tmp__56, (signed short *)llvm_cbe_tmp__55);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__119:
if (AESL_DEBUG_TRACE)
printf("\n  %%63 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_345_count);
  llvm_cbe_tmp__113 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__113);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%64 = getelementptr inbounds %%struct._iobuf* %%63, i64 1, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_346_count);
  llvm_cbe_tmp__114 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__113[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%65 = call i64 @fwrite(i8* getelementptr inbounds ([30 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64 29, i64 1, %%struct._iobuf* %%64), !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_347_count);
  fwrite(( char *)((&aesl_internal__OC_str1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 30
#endif
])), 29ull, 1ull, (l_struct_OC__iobuf *)llvm_cbe_tmp__114);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__120:
if (AESL_DEBUG_TRACE)
printf("\n  %%67 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_349_count);
  llvm_cbe_tmp__116 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__116);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%68 = getelementptr inbounds %%struct._iobuf* %%67, i64 2, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_350_count);
  llvm_cbe_tmp__117 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__116[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%69 = call i64 @fwrite(i8* getelementptr inbounds ([30 x i8]* @aesl_internal_.str2, i64 0, i64 0), i64 29, i64 1, %%struct._iobuf* %%68), !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_351_count);
  fwrite(( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 30
#endif
])), 29ull, 1ull, (l_struct_OC__iobuf *)llvm_cbe_tmp__117);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",29ull);
printf("\nArgument  = 0x%I64X",1ull);
