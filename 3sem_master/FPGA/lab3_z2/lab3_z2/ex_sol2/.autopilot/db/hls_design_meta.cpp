...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inA_ar_address0", 13, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("inA_ar_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("inA_ar_q0", 16, hls_in, 0, "ap_memory", "in_data", 1),
	Port_Property("out_ar_address0", 13, hls_out, 1, "ap_memory", "mem_address", 1),
	...
	Port_Property("out_ar_address1", 13, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("out_ar_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("out_ar_q1", 16, hls_in, 1, "ap_memory", "in_data", 1),
};
