...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "6", "7", "8", "9", "10", "11", "12"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "Loop_Loop1_proc_U0"}],
		"OutputProcess" : [
			{"ID" : "4", "Name" : "Loop_Loop2_proc_U0"},
			{"ID" : "6", "Name" : "Loop_Loop3_proc_U0"}],
		"Port" : [
			{"Name" : "data_in", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "Loop_Loop1_proc_U0", "Port" : "data_in"}]},
			{"Name" : "scale", "Type" : "None", "Direction" : "I"},
			{"Name" : "data_out1", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "Loop_Loop2_proc_U0", "Port" : "data_out1"}]},
			{"Name" : "data_out2", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Loop_Loop3_proc_U0", "Port" : "data_out2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_Loop1_proc_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			{"Name" : "data_in", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "scale", "Type" : "None", "Direction" : "I"},
			{"Name" : "temp1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["3"], "DependentChan" : "7", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "temp1_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "Loop1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "5", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state5"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_Loop1_proc_U0.mul_32s_32s_32_1_1_U1", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.split_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "in_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "7", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "in_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["4"], "DependentChan" : "8", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "out1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["6"], "DependentChan" : "9", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "out2_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "L1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_Loop2_proc_U0", "Parent" : "0", "Child" : ["5"],
		...
		"IsBlackBox" : "0",
		"StartSource" : "3",
		"StartFifo" : "start_for_Loop_Loop2_proc_U0_U",
		"Port" : [
			{"Name" : "temp2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "8", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "temp2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_out1", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "Loop2", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "4", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state4"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_Loop2_proc_U0.mul_32s_6ns_32_1_1_U9", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_Loop3_proc_U0", "Parent" : "0",
		...
		"IsBlackBox" : "0",
		"StartSource" : "3",
		"StartFifo" : "start_for_Loop_Loop3_proc_U0_U",
		"Port" : [
			{"Name" : "temp3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "9", "DependentChanDepth" : "16384", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "temp3_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "data_out2", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.temp3_U", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_split_U0_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Loop_Loop2_proc_U0_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Loop_Loop3_proc_U0_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "65541", "Max" : "65541"}
