...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab4_z1.autotvin_firstVector_arr.dat"
         "c.lab4_z1.autotvin_secondVector_arr.dat"
         "c.lab4_z1.autotvin_resultVecror_arr.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab4_z1.autotvout_resultVecror_arr.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
