...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i32 %%storemerge3 to i64, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__1 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge3);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds i16* %%secondVector_arr, i64 %%1, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_17_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds i32* %%resultVecror_arr, i64 %%1, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__3 = (signed int *)(&llvm_cbe_resultVecror_arr[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i16* %%firstVector_arr, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__4 = (unsigned short )*llvm_cbe_firstVector_arr;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i16 %%4 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__5 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i16* %%2, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__6 = (unsigned short )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i16 %%6 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__7 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = mul nsw i32 %%7, %%5, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_23_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i32* %%3, align 4, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = add nsw i32 %%8, %%9, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_25_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%10, i32* %%3, align 4, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_26_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds i16* %%firstVector_arr, i64 1, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_31_count);
  llvm_cbe_tmp__11 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i16* %%11, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__12 = (unsigned short )*llvm_cbe_tmp__11;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i16 %%12 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__13 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i16* %%2, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__14 = (unsigned short )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = sext i16 %%14 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__15 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = mul nsw i32 %%15, %%13, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_36_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add nsw i32 %%16, %%10, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_37_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%17, i32* %%3, align 4, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_38_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__17;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds i16* %%firstVector_arr, i64 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__18 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i16* %%18, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__19 = (unsigned short )*llvm_cbe_tmp__18;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = sext i16 %%19 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__20 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i16* %%2, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_46_count);
  llvm_cbe_tmp__21 = (unsigned short )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = sext i16 %%21 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_47_count);
  llvm_cbe_tmp__22 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = mul nsw i32 %%22, %%20, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_48_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = add nsw i32 %%23, %%17, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_49_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%24, i32* %%3, align 4, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_50_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__24;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = getelementptr inbounds i16* %%firstVector_arr, i64 3, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_55_count);
  llvm_cbe_tmp__25 = (signed short *)(&llvm_cbe_firstVector_arr[(((signed long long )3ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i16* %%25, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_56_count);
  llvm_cbe_tmp__26 = (unsigned short )*llvm_cbe_tmp__25;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = sext i16 %%26 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_57_count);
  llvm_cbe_tmp__27 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load i16* %%2, align 2, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_58_count);
  llvm_cbe_tmp__28 = (unsigned short )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = sext i16 %%28 to i32, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_59_count);
  llvm_cbe_tmp__29 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = mul nsw i32 %%29, %%27, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_60_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = add nsw i32 %%30, %%24, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_61_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%31, i32* %%3, align 4, !dbg !2 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_62_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__31;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = add nsw i32 %%storemerge3, 1, !dbg !3 for 0x%I64xth hint within @lab4_z1  --> \n", ++aesl_llvm_cbe_67_count);
