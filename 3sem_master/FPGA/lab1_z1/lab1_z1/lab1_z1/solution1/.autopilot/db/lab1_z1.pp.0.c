...
# 2 "<built-in>" 2
# 1 "source/lab1_z1.c" 2
# 1 "source/lab1_z1.h" 1
typedef short din_type;
typedef int dout_type;

__attribute__((sdx_kernel("lab1_z1", 0))) dout_type lab1_z1(din_type a, din_type b, din_type c, din_type d);
# 2 "source/lab1_z1.c" 2
__attribute__((sdx_kernel("lab1_z1", 0))) dout_type lab1_z1(din_type a, din_type b, din_type c, din_type d)
{
#pragma HLSDIRECTIVE TOP name=lab1_z1
# 3 "source/lab1_z1.c"
