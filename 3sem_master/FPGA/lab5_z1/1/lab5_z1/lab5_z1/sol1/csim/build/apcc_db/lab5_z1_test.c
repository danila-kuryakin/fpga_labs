...
llvm_cbe_tmp__86:
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 bitcast (i32 (...)* @foo_m to i32 (i32*, i32, i32*, i32*)*)(i32* %%1, i32 %%8, i32* %%2, i32* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
  foo_m((signed int *)llvm_cbe_tmp__22, llvm_cbe_tmp__29, (signed int *)llvm_cbe_tmp__23, (signed int *)llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__96:
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = call i32 bitcast (i32 (...)* @foo_m to i32 (i32*, i32, i32*, i32*)*)(i32* %%1, i32 %%43, i32* %%2, i32* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_195_count);
  foo_m((signed int *)llvm_cbe_tmp__22, llvm_cbe_tmp__55, (signed int *)llvm_cbe_tmp__23, (signed int *)llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE) {
