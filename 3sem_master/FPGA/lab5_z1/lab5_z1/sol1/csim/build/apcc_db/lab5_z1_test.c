...
printf("\n  %%16 = call i32 bitcast (i32 (...)* @foo_m to i32 (i32*, i32, i32*, i32*)*)(i32* %%1, i32 %%8, i32* %%2, i32* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_152_count);
  foo_m((signed int *)llvm_cbe_tmp__41, llvm_cbe_tmp__48, (signed int *)llvm_cbe_tmp__42, (signed int *)llvm_cbe_tmp__43);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__70:
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 bitcast (i32 (...)* @foo_m to i32 (i32*, i32, i32*, i32*)*)(i32* %%1, i32 %%19, i32* %%2, i32* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_184_count);
  foo_m((signed int *)llvm_cbe_tmp__41, llvm_cbe_tmp__57, (signed int *)llvm_cbe_tmp__42, (signed int *)llvm_cbe_tmp__43);
if (AESL_DEBUG_TRACE) {
