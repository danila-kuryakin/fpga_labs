...
set C_modelArgList {
	{ buf_2d_in int 16 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	buf_2d_in { ap_memory {  { buf_2d_in_address0 mem_address 1 6 }  { buf_2d_in_ce0 mem_ce 1 1 }  { buf_2d_in_we0 mem_we 1 1 }  { buf_2d_in_d0 mem_din 1 16 } } }
	input_r { ap_memory {  { input_r_address0 mem_address 1 6 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 16 } } }
}
