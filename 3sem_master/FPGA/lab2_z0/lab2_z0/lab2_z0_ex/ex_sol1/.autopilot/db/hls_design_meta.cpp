...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_a_address0", 2, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("in_a_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("in_a_q0", 16, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("in_b_address0", 2, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("in_b_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("in_b_q0", 16, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("res_address0", 2, hls_out, 2, "ap_memory", "mem_address", 1),
...
const char* HLS_Design_Meta::dut_name = "lab2_z0";
